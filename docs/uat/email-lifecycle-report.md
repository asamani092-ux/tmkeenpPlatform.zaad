...
| 3 | استعادة كلمة المرور | `/forgot-password` | إن وُجد البريد يُرسل الرابط؛ وإلا رسالة «البريد غير مسجّل» | «إعادة تعيين كلمة المرور» + رابط **10 دقائق**؛ رفض نفس المرور عند التعيين | `forgot-password` / `reset-password` |
...
- نسيت كلمة المرور: قرار منتج — إظهار «البريد غير مسجّل» إن لم يوجد الحساب؛ صلاحية الرابط 10 دقائق.  
- تعيين كلمة المرور عبر `/reset-password` **لا يرسل** بريداً إضافياً؛ يرفض إعادة استخدام نفس كلمة المرور.
