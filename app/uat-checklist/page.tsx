      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-primary">
            تقييم المتبقي بعد النشر — منصة تمكين
          </h1>
          <p className="mt-2 text-sm text-brand-gray">
            البنود الثمانية (بريد حي + جلسة + إشعارات). يُحفظ تلقائياً في المتصفح.
          </p>
          <p className="mt-2 rounded-lg border border-primary/30 bg-primary/5 px-3 py-2 text-sm font-semibold text-primary">
            أعلى الصفحة: «تصدير النتائج للوكيل» — ويمكن التبديل إلى «كل البنود» إن لزم
          </p>
        </div>
        <UatChecklistForm />
      </main>
